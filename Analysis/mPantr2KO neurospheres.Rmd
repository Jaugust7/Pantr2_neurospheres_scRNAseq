...
pdf("../Plots/cell_cycle_umap.pdf", height = 6, width = 8)
plot_cells_3d(dat, color_cells_by = "cell_cycle", show_trajectory_graph = FALSE)
dev.off()
...
plot_genes_by_group(dat, group_cells_by="genotype", markers = diffs.names) + theme_pubr()
dev.off()
...
assay(dat, "logcounts")<-log10(exprs(dat) + 1)
...
plot_emb_circle_scale(dat, dimred="tricycleEmbedding", facet_by = "genotype", point.size = 0.5)
dev.off()
